    ...
    return (
      <div style={{ width: '100%', maxWidth: '888px', height: '500px', borderRadius: '20px' }}>
        <Carousel style={{ height: 'auto' }}>
            <Carousel.Item onClick={() => navigate("/Employees")} interval={1500}
          ...
          <Carousel.Item onClick={() => navigate("/Documentary")} interval={1500}
            style={{ cursor: 'pointer' }}>
            <img
              className="d-block w-100"
              src={image_two}
          ...
          <Carousel.Item onClick={() => navigate("/Contact")} interval={1500}
            style={{ cursor: 'pointer' }}>
            <img
              className="d-block w-100"
              src={image_three}
